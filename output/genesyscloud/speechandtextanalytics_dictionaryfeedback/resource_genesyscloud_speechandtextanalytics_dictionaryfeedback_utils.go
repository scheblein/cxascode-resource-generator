...
// getSpeechandtextanalyticsDictionaryfeedbackFromResourceData maps data from schema ResourceData object to a platformclientv2.Dictionaryfeedback
func getSpeechandtextanalyticsDictionaryfeedbackFromResourceData(d *schema.ResourceData) platformclientv2.Dictionaryfeedback {
